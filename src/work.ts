...
export const works: Work[] = [
  {
    ...
    role: "Director / DP",
    year: "Year",
    plate: "/plates/study-lens.jpg",
    status: "todo",
    blurb: "TODO — Aaron: film title, role, year. This plate is a light study, not a credit.",
  },
  {
    slug: "todo-film-02",
    lane: "film",
  ...
  },
  {
    ...
    role: "Photographer",
    year: "Year",
    plate: "/plates/study-tungsten.jpg",
    status: "todo",
